...
Dependencies := rec(
  ...
  NeededOtherPackages := [ [ "MatricesForHomalg", ">= 2011.06.29" ], [ "homalg", ">= 2011.06.23" ], [ "GAPDoc", ">= 1.0" ] ],
...
BannerString := Concatenation( 
  "----------------------------------------------------------------\n",
  "Loading  AbelianSystems ", ~.Version, "\n",
...
#        " (", ~.Persons[3].WWWHome, ")\n",
  "For help, type: ?AbelianSystems package \n",
  "----------------------------------------------------------------\n" ),
